    ...
    handler: async (request, reply) => {
      ...
      switch (typeGraph) {
        ...
        case 3:
          if (sex === 1)
            query =
              "SELECT MH_LESS3 AS LESS5, MH_LESS3 AS LESS3, MH_NORMALMAX AS LESS1, MH_MORE2 AS MORE2, MONTH AS XVALUE FROM `GL_GROWTH_CHILD_AGE_WHO`";
          else
            query =
              "SELECT FH_LESS3 AS LESS5, FH_LESS3 AS LESS3, FH_NORMALMAX AS LESS1, FH_MORE2 AS MORE2, MONTH AS XVALUE FROM `GL_GROWTH_CHILD_AGE_WHO`";
          break;

        case 4:
          if (sex === 1)
            query =
              "SELECT MW_LESS3 AS LESS5, MW_LESS3 AS LESS3, MW_NORMALMAX AS LESS1, MW_MORE2 AS MORE2, MONTH AS XVALUE FROM `GL_GROWTH_CHILD_AGE_WHO`";
          else
            query =
              "SELECT FW_LESS3 AS LESS5, FW_LESS3 AS LESS3, FW_NORMALMAX AS LESS1, FW_MORE2 AS MORE2, MONTH AS XVALUE FROM `GL_GROWTH_CHILD_AGE_WHO`";
          break;
